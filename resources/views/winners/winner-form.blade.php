<div class="form-group {{ $errors->has('winner_name') ? ' has-danger' : '' }}">
...
<div class="form-group {{ $errors->has('show_name') ? ' has-danger' : '' }}">
...
<div class="form-group {{ $errors->has('rj_name') ? ' has-danger' : '' }}">
...
<div class="form-group {{ $errors->has('contest_id') ? ' has-danger' : '' }}">
...
<div class="form-group {{ $errors->has('gift_issued_date') ? ' has-danger' : '' }}">
